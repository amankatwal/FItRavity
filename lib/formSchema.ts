...
export const addPlanSchema = z.object({
  ...
  .min(3, "Please add at least 3 achievements"),
    ...
    duration1Info: z.string().min(30, "Atleast 30 characters").max(300,"Can't exceed 300 Characters"),
    duration2: z.string().min(10, "Atleast 10 characters").max(50,"Can't exceed 50 Characters"),
    duration2Info: z.string().min(30, "Atleast 30 characters").max(300,"Can't exceed 300 Characters"),
    duration3: z.string().min(10, "Atleast 10 characters").max(50,"Can't exceed 50 Characters"),
    duration3Info: z.string().min(30, "Atleast 30 characters").max(300,"Can't exceed 300 Characters"),
    equipment:z.string(),
    focusArea: z.string(),
    goal: z.string(),
