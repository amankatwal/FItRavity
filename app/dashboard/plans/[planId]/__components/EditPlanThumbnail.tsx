...
export default function EditPlanThumbnail() {
  ...
  const hasThumbnail =
    !!plan?.planThumbnail ||
    planThumbnail.uploading ||
    planThumbnail.isDeleting;
      ...
      {hasThumbnail ? (
        ...
        <Card className='flex justify-center items-center max-w-3xl mx-auto h-[30vh]'>
          ...
          >
            ...
            {planThumbnail.uploading || planThumbnail.isDeleting ? (
              ...
              <div className='bg-black/50 w-full h-full absolute z-10 flex justify-center items-center'>
                ...
                <AnimatedButton
                  ...
                  onClick={async () => {
                    ...
                    if (!plan?.planThumbnail) return;

                    await deletePlanThumbnail(
                      plan?.planThumbnail
                    );
            ...
            <Image
              src={
                planThumbnail.objectURL
                  ? planThumbnail.objectURL
                  : `https://res.cloudinary.com/dwyvsmlx3/image/upload/${plan?.planThumbnail}`
              }
              alt='Profile'
              width={300}
              height={300}
