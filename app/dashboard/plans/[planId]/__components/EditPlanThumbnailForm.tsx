...
import EditPlanThumbnail from './EditPlanThumbnail'


export default function EditPlanThumbnailForm() {
    const { planThumbnail } = useProgramForm();
  ...
  React.useEffect(() => {
    ...
    if (planThumbnail.key) {
      form.setValue("picture", planThumbnail.key);
    }
